  ...
  <PayPalButton
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Royal Vyto "
              description="Royal is a free multipage website built with the Bootstrap 4 framework that has been specifically intended for resort and hotel websites. It is simply beautiful in its simplicity. It is a highly responsive website that comes with a comprehensive range of practical contemporary features. "
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Vyto Estate"
              description="Both real estate agents and property owners can use this website. This clean and extraordinary website is ideal for selling villas, apartments, land, and houses, among other things. Vyto Estate is completely free to use !"
